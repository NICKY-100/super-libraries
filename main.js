...
const yellowBox = $e({ tag: 'div', backgroundColor: 'yellow', width: '100px', height: '100px' })
yellowBox.appendTo(grid.element)

// extra box for exercise(BLUE)
const blueBox = $e({ tag: 'div' })// superBox "div"
...
const select = $e('box-alignment', // new
  [
...
const submit = $e({ type: 'submit', options: 'submit' }) // SuperButton
